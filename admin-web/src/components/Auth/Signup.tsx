...
import { WarningComponent } from "@/app/ui/WarningComponent";
...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!(await validateForm(formData, SignupValidationSchema, setErrors))) {
      return;
    }
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors?.name && <WarningComponent message={errors.name} />}
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors?.email && (
                      <WarningComponent message={errors.email} />
                    )}
                    <span className="absolute right-4 top-4">
                      <svg
                        className="fill-current"
                ...
                {errors?.password && (
                  <WarningComponent message={errors.password} />
                )}
                <div className="mb-6">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                ...
                {errors?.rePassword && (
                  <WarningComponent message={errors.rePassword} />
                )}
                <div className="mb-5">
                  <input
                    type="submit"
