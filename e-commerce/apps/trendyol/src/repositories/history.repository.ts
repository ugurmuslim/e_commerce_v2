...
import { DEFAULT_CONNECTION, SHARED_CONNECTION } from '@app/common/constants/connections';
...
export class HistoryRepository extends AbstractRepository<HistoryDocument> {
    ...
    constructor(@InjectModel(HistoryDocument.name, DEFAULT_CONNECTION) historyModel: Model<HistoryDocument>) {
        super(historyModel);
    }
}